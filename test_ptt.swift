...
class MyClass: NSObject, PTChannelManagerDelegate, PTChannelRestorationDelegate {
    ...
    func incomingPushResult(channelManager: PTChannelManager, channelUUID: UUID, pushPayload: [String : Any]) -> PTPushResult { return .activeRemoteParticipant(PTMutableParticipant(name: "a", image: nil)) }
    func channelDescriptor(restoredChannelUUID channelUUID: UUID) -> PTChannelDescriptor { return PTChannelDescriptor(name: "a", image: nil) }
